...
class SendersControllerTest < ActionController::TestCase
  ...
  test "should create sender" do
    assert_difference('Sender.count') do
      post :create, sender: { identity_document: @sender.identity_document, name_reason: @sender.name_reason, ruc: @sender.ruc }
    end
  ...
  test "should update sender" do
    patch :update, id: @sender, sender: { identity_document: @sender.identity_document, name_reason: @sender.name_reason, ruc: @sender.ruc }
    assert_redirected_to sender_path(assigns(:sender))
  end
